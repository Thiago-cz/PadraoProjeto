...
public class Minimalista implements ICasaConcreto {
    ...
    public Minimalista(double tamanho, String cores, double orcamento, int quartos, int banheiros) {
    ...
    @Override
    public void exibirInfoCasaConcreto() {
