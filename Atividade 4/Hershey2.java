public class Hershey2 extends OvoDePascoa implements IOvoDePascoa{

    public Hershey2(double peso, String cor, double calorias, double teorGordura, double qualidadePureza) {
