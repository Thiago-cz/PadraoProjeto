public class FerreiroRocher2 extends OvoDePascoa implements IOvoDePascoa {

    public FerreiroRocher2(double peso, String cor, double calorias, double teorGordura, double qualidadePureza) {
