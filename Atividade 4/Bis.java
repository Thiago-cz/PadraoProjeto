public class Bis extends OvoDePascoa implements IOvoDePascoa{

    public Bis(double peso, String cor, double calorias, double teorGordura, double qualidadePureza) {
