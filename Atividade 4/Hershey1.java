public class Hershey1 extends OvoDePascoa implements IOvoDePascoa{

    public Hershey1(double peso, String cor, double calorias, double teorGordura, double qualidadePureza) {
