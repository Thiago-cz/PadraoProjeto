public class Talento extends OvoDePascoa implements IOvoDePascoa {

    public Talento(double peso, String cor, double calorias, double teorGordura, double qualidadePureza) {
