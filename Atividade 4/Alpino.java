public class Alpino extends OvoDePascoa implements IOvoDePascoa {

    public Alpino(double peso, String cor, double calorias, double teorGordura, double qualidadePureza) {
