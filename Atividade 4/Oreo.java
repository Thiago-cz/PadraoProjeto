public class Oreo extends OvoDePascoa implements IOvoDePascoa {

    public Oreo(double peso, String cor, double calorias, double teorGordura, double qualidadePureza) {
