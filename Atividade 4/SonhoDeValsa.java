public class SonhoDeValsa extends OvoDePascoa implements IOvoDePascoa {

    public SonhoDeValsa(double peso, String cor, double calorias, double teorGordura, double qualidadePureza) {
