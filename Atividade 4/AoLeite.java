public class AoLeite extends OvoDePascoa implements IOvoDePascoa {

    public AoLeite(double peso, String cor, double calorias, double teorGordura, double qualidadePureza) {
