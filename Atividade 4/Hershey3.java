public class Hershey3 extends OvoDePascoa implements IOvoDePascoa{

    public Hershey3(double peso, String cor, double calorias, double teorGordura, double qualidadePureza) {
