public class KitKat extends OvoDePascoa implements IOvoDePascoa {

    public KitKat(double peso, String cor, double calorias, double teorGordura, double qualidadePureza) {
